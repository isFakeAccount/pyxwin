...
def run_static_and_lint() -> bool:
    ...
    success &= do_process(["poetry", "run", "mypy", "src/"])
    success &= do_process(["poetry", "run", "pyright", "src/"])

    success &= do_process(["poetry", "run", "docstrfmt", "src/"])

    success &= do_process(["poetry", "run", "ruff", "format", "src/"])
